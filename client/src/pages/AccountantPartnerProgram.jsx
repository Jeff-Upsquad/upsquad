...
const LP_SLUG = 'partnerprogram-accountant'
const LP_FALLBACK_SLUG = 'partner-program-accountant'
...
const TABS = [
  {
    ...
    desc: 'Subscriptions with assigned businesses, plus one-time assignments.',
  ...
  },
  {
    ...
    desc: 'Open accounting roles from companies hiring through UpSquad.',
    meta: 'Apply directly',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
