  ...
  return (
    <div className="overflow-x-auto pb-4">
      <div className="min-w-[900px]">
        {/* Plan Headers */}
        <div className="grid grid-cols-[180px_repeat(5,1fr)] gap-0">
        ...
        {/* Price Row */}
        <div className="grid grid-cols-[180px_repeat(5,1fr)] gap-0 border-t border-gray-200">
        ...
        {featureRows.map((row, rowIdx) => (
          <div
            key={row.label}
            className="grid grid-cols-[180px_repeat(5,1fr)] gap-0 border-t border-gray-100"
          >
            <div className="flex items-center px-4 py-4">
        ...
        {/* CTA Row */}
        <div className="grid grid-cols-[180px_repeat(5,1fr)] gap-0 pt-4">
          <div />
          {plans.map((plan) => (
