...
import { ACCOUNTANT_PLANS, formatInr } from '../data/offer'
...
export default function AccountantOfferLanding() {
  ...
  const plan = ACCOUNTANT_PLANS.find((item) => item.id === planId)
  const dueNow = plan?.price || 0
    ...
    fetchOfferReservation(paidId)
      .then((data) => {
        ...
        if (data?.status === 'paid') {
          setConfirmed({
            name: data.name,
            roleNoun: data.roleNoun || 'accountant',
        ...
        <div className="max-w-[640px] mx-auto">
          <div className="rounded-2xl border-[1.5px] border-black bg-white p-8 sm:p-10 shadow-brutal">
            ...
            <p className="mt-4 text-text-secondary leading-relaxed">
              We&apos;ll match you with an {confirmed.roleNoun} based on your preference.
            ...
            <dl className="mt-8 divide-y divide-black/[0.08] border-y border-black/[0.08]">
              {[
                ['Role', 'Accountant'],
                ['Plan', `${confirmed.plan.name} · ${confirmed.plan.hoursPerDay} hours / day`],
            ...
            <a
              href="https://wa.me/919995266385?text=I%20just%20reserved%20a%20first-month%20accountant%20slot%20on%20UpSquad"
              target="_blank"
    ...
    <>
          ...
          <div className="min-w-0">
            ...
            <ScrollReveal delay={0.08} className="min-w-0">
              <h1 className="font-heading text-[1.85rem] sm:text-4xl md:text-5xl lg:text-[56px] font-extrabold leading-[1.1] tracking-[-0.03em] text-text-primary">
                <span className="block">A dedicated accountant for your books.</span>
                <span
            ...
            <ScrollReveal delay={0.16}>
              <p className="mt-5 text-base md:text-lg text-text-secondary leading-relaxed max-w-xl text-pretty">
                Pick 2 or 4 hours a day, then pay to lock the slot. We match a vetted
                accountant to your books and software. If they are not a fit, you get
                every rupee back.
              </p>
            </ScrollReveal>
      ...
      <section className="py-10 px-5 sm:px-8 bg-surface-secondary border-y border-black/[0.06]">
        <div className="max-w-[1160px] mx-auto grid sm:grid-cols-3 gap-6">
          {[
            { n: '01', t: 'Choose the hours', d: '2 hours a day at ₹5,000, or 4 hours at ₹10,000.' },
            { n: '02', t: 'Pay to lock the slot', d: 'First come, first reserved. We match after payment.' },
            { n: '03', t: 'Meet your accountant', d: 'Matched to your books and software. Full refund if not a fit.' },
          ].map((step) => (
            <div key={step.n}>
          ...
          <div className="min-w-0">
            ...
            <div id="who" className="scroll-mt-28 mt-10 rounded-2xl border-[1.5px] border-black/[0.08] bg-surface-secondary p-6 sm:p-7">
              ...
              <p className="mt-3 text-text-secondary leading-relaxed">
                You choose the hours — 2 or 4 a day. We then match an accountant to your
                preference — software (Tally, Zoho Books…), workload, industry, whatever
                you tell us in the form. One person, selected for you.
              </p>
              <p className="mt-3 text-text-secondary leading-relaxed">
            ...
            >
              ...
              <div className="mt-5 rounded-xl bg-surface-secondary border border-black/[0.06] p-4 text-sm">
                <div className="flex justify-between gap-3">
                  ...
                  <span className="font-medium text-text-primary text-right">Accountant</span>
                </div>
              ...
              <div className="mt-5 space-y-3">
                ...
                <label className="block">
                  ...
                  <textarea
                    ...
                    rows={3}
                    placeholder="Software (Tally, Zoho Books…), GST/TDS, payroll, industry — anything that helps us match the right person."
