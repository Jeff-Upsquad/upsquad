export const metadata = {
  title: 'UpSquad Partner Program — For Sales Professionals',
  description: 'Partner with UpSquad as a sales professional — get assigned businesses to sell for, pick up one-time sales assignments, or find full-time and part-time sales jobs.',
}

export default function SalesPartnerLayout({ children }) {
  return (
    <>
