    ...
    <section className="pt-32 pb-20 px-5 sm:px-8">
      <div className="max-w-[1160px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white border border-[rgba(0,0,0,0.08)] rounded-xl p-8 shadow-sm hover:shadow-card-hover transition-all duration-short">
          ...
          <div className="bg-white border border-[rgba(0,0,0,0.08)] rounded-xl p-8 shadow-sm hover:shadow-card-hover transition-all duration-short">
            ...
            <div className="rounded-xl overflow-hidden border border-[rgba(0,0,0,0.08)] w-full" style={{ height: '200px' }}>
              <iframe
