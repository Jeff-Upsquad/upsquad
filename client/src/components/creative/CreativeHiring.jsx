...
const waLink = (pkg) =>
  `https://wa.me/${WA_NUMBER}?text=${encodeURIComponent(
    `Hi UpSquad, I’m interested in the ${pkg} designer / video editor hiring package.`
  )}`

// Pricing for the hire packages. `amount` is shown big; `unit` is the small line under it.
// Carried over from the accountant hiring packages — adjust if creative hiring fees differ.
const PRICING = {
...
const steps = [
  ...
  { n: '2', t: 'We shortlist', d: 'Vetted designers and editors matched to your brief.' },
      ...
      <div className="max-w-[1160px] mx-auto">
        ...
        <ScrollReveal>
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-extrabold text-text-primary tracking-[-0.025em] max-w-3xl">
            Post a job and hire vetted designers &amp; editors — with a{' '}
          ...
          <p className="mt-4 text-base md:text-lg text-text-secondary leading-relaxed max-w-2xl">
            ...
            designers or editors matched to your brief, you interview and hire who you want, and if
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-between gap-4 rounded-2xl border-[1.5px] border-black bg-brand-purple/15 px-7 py-6 shadow-brutal-sm">
            <div>
              ...
              <p className="text-sm text-text-secondary mt-1">
                Tell us what your brand needs and we’ll point you to the right option.
                We reply same-day, 10 AM–6 PM IST, Monday to Friday.
              </p>
            </div>
            <a
              href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent(
                'Hi UpSquad, help me choose between a designer / video editor subscription and hiring.'
              )}`}
              target="_blank"
              rel="noopener noreferrer"
