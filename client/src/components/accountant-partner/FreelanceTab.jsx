...
const howItWorks = [
  {
    ...
    description: 'New accounting and compliance tasks are posted regularly. Each one lists the scope, the fixed fee, and the deadline upfront.',
  },
  {
    number: '2',
...
const assignmentTypes = [
  { category: 'Bookkeeping', accent: 'purple', title: 'Monthly bookkeeping (1 month)', start: '22 Jun', due: '25 Jun', duration: '3 days', fee: '2,000' },
  { category: 'Bookkeeping', accent: 'purple', title: 'Accounts payable / receivable', start: '22 Jun', due: '26 Jun', duration: '4 days', fee: '2,500' },
  { category: 'Bookkeeping', accent: 'purple', title: 'MIS report pack', start: '23 Jun', due: '26 Jun', duration: '3 days', fee: '2,800' },
  { category: 'Compliance', accent: 'blue', title: 'Payroll processing (1 cycle)', start: '23 Jun', due: '25 Jun', duration: '2 days', fee: '1,800' },
  { category: 'Compliance', accent: 'blue', title: 'ROC / MCA annual filing', start: '24 Jun', due: '28 Jun', duration: '4 days', fee: '3,000' },
  { category: 'Compliance', accent: 'blue', title: 'GST returns (2 months)', start: '24 Jun', due: '27 Jun', duration: '3 days', fee: '2,000' },
]
        ...
        <section className="py-16 lg:py-20 px-5 sm:px-8 bg-surface-secondary">
          <div className="max-w-[1160px] mx-auto">
            ...
            <p className="mt-4 text-base md:text-lg text-text-secondary leading-relaxed max-w-2xl">
              Not ready to commit to a regular client? Browse standalone accounting and compliance
              ...
              deliver clean work, and get paid. No strings attached.
            </p>
