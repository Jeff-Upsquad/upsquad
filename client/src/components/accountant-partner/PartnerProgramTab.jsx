...
const upsquadHandles = [
  {
    ...
    desc: 'We find and close clients — you never have to pitch for work.',
    icon: (
  ...
  },
  {
    ...
    desc: 'We promote your expertise to the right businesses.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'We handle all communication, queries, and follow-ups.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const partnerFocus = [
  {
    title: 'Focus on the Numbers',
    desc: 'Just do what you do best — bookkeeping, GST, payroll, reporting.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M9 7h6m-6 4h6m-6 4h4M5 4h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5a1 1 0 011-1z" />
      </svg>
    ),
  },
  {
    title: 'Per-Client Payment',
    desc: 'Earn per business assigned — not per task or per hour.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const whyFeatures = [
  {
    ...
    desc: 'We assign businesses to you — no more hunting for clients or chasing the next engagement.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'Work regularly for your assigned businesses and get paid every month. No chasing invoices.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
  ...
  },
  {
    ...
    desc: 'Sales, marketing, client support, and collections are all on us. You never touch the admin.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Focus only on the numbers',
    desc: 'A dedicated Squad Manager handles clients, so you can keep the books clean and filings on time.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M9 7h6m-6 4h6m-6 4h4M5 4h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5a1 1 0 011-1z" />
      </svg>
...
const gettingStartedSteps = [
  {
    ...
    description: 'Share your basic details, qualifications (CA, CMA, B.Com, or equivalent), and experience. We build a professional profile that showcases your expertise.',
  },
  {
    number: '2',
    title: 'Profile Presented to Clients',
    description: 'Your profile is shared with our active clients who are looking for accounting talent that matches your skill set.',
  },
  {
    number: '3',
...
const partnerVsFreelance = {
  partner: [
    ...
    'Paid per business assigned — not per filing or task',
  ...
  freelance: [
    ...
    'Paid per filing, return, or individual engagement',
            ...
            <div className="mb-8 flex items-end justify-between flex-wrap gap-4">
              <div className="max-w-2xl">
                ...
                <h2 className="font-heading text-3xl sm:text-4xl font-extrabold text-text-primary leading-[1.1] tracking-tight">
                  ...
                  <span className="italic font-medium text-text-muted">Start keeping books.</span>
                </h2>
              </div>
              <p className="text-sm text-text-secondary leading-relaxed max-w-sm">
                The freelance grind drains your energy on everything except the work itself. Here&apos;s what you get when you partner with UpSquad.
              </p>
            </div>
        ...
        <section className="py-20 px-5 sm:px-8 bg-white">
          <div className="max-w-[1160px] mx-auto">
            <div className="mb-12">
              ...
              <p className="text-base text-text-secondary mt-2">You handle the numbers. We handle everything else.</p>
            </div>
        ...
        <section className="py-20 px-5 sm:px-8 bg-white">
          <div className="max-w-[1160px] mx-auto">
            <div className="mb-12">
              ...
              <p className="text-base text-text-secondary mt-2 max-w-2xl">
                Based on your experience, qualifications, and skill set, your profile will be placed into one of three tiers.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="rounded-xl p-6 border border-[rgba(96,96,163,0.2)] bg-surface-secondary hover:-translate-y-0.5 transition-transform duration-200">
                ...
                <p className="text-sm text-text-secondary leading-relaxed mb-4">
                  Less than 2 years of experience, or semi-qualified. Great for bookkeeping, data entry, and cost-effective routine work.
                </p>
                <div className="flex items-center gap-2 text-xs text-text-muted">
                  <svg className="w-3.5 h-3.5 text-brand-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  Ideal for starting your accounting career
                </div>
              </div>
              ...
              <div className="rounded-xl p-6 border-2 border-brand-purple bg-brand-purple/5 hover:-translate-y-0.5 transition-transform duration-200 relative">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] text-text-muted font-medium">2+ Years / Qualified</span>
                  </div>
                </div>
                <p className="text-sm text-text-secondary leading-relaxed mb-4">
                  More than 2 years of experience with strong, well-rounded skills across bookkeeping, GST, TDS, and payroll. Reliable quality.
                </p>
                <div className="flex items-center gap-2 text-xs text-text-muted">
              ...
              <div className="rounded-xl p-6 border border-[rgba(96,96,163,0.2)] bg-surface-secondary hover:-translate-y-0.5 transition-transform duration-200">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] text-text-muted font-medium">5+ Years / CA</span>
                  </div>
                </div>
                <p className="text-sm text-text-secondary leading-relaxed mb-4">
                  Chartered Accountants and specialists with 5+ years of experience. Best for complex compliance, audits, and advisory work.
                </p>
                <div className="flex items-center gap-2 text-xs text-text-muted">
        ...
        <section className="py-20 px-5 sm:px-8 bg-surface-secondary">
          <div className="max-w-[1160px] mx-auto">
            ...
            <p className="text-xs text-text-muted text-center mt-6">
              * Scope is selected by the client. Payments shown are approximate partner earnings per client.
            </p>
          </div>
        </section>
      </ScrollReveal>
