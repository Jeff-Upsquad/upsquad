...
const howItWorks = [
  {
    ...
    description: 'Tell us your role, skills, qualifications, expected salary, and where you want to work.',
  },
  {
    number: '2',
...
const sampleOpenings = [
  ...
  {
    role: 'Senior Accountant / GST Specialist',
...
const feeTiers = [
  {
    label: 'Salary package below ₹25,000',
    amount: '₹3,000',
    note: 'One-time placement fee',
  },
  {
    label: 'Salary package ₹25,000 & above',
    amount: '₹5,000',
    note: 'One-time placement fee',
    highlighted: true,
  },
        ...
        <section className="py-16 lg:py-20 px-5 sm:px-8 bg-white">
          <div className="max-w-[1160px] mx-auto">
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-extrabold text-text-primary tracking-[-0.025em] max-w-3xl">
              Land a full-time or part-time accounting job with companies hiring through UpSquad.
            </h2>
            <p className="mt-4 text-base md:text-lg text-text-secondary leading-relaxed max-w-2xl">
              Companies and brands that work with UpSquad are hiring accountants and bookkeepers for
