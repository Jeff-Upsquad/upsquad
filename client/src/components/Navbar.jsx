  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-white/70 backdrop-blur-xl border-b border-[rgba(96,96,163,0.15)] shadow-xs'
          : 'bg-transparent'
      }`}
    >
      <div className="max-w-[1160px] mx-auto px-5 sm:px-8">
        <div className="flex items-center justify-between h-[76px]">
          ...
          <Link href="/" className="flex items-center gap-0.5">
            <span className="font-heading font-extrabold text-xl text-text-primary tracking-tight">Up</span>
            <span className="font-heading font-extrabold text-xl text-text-primary tracking-tight">Squad</span>
          </Link>
        ...
        {/* Mobile menu */}
        {menuOpen && (
          <div className="md:hidden bg-white border-t border-[rgba(96,96,163,0.15)] py-3 space-y-0.5">
            {isHome ? (
              <>
