        ...
        <section className="py-16 lg:py-20 px-5 sm:px-8 bg-white">
          <div className="max-w-[1160px] mx-auto">
            ...
            <p className="mt-4 text-base md:text-lg text-text-secondary leading-relaxed max-w-2xl">
              Companies and brands that work with UpSquad are hiring designers and video editors for
              full-time and part-time roles. Browse new openings, and when one matches what you&apos;re looking for,
