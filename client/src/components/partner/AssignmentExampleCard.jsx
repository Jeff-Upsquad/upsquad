...
export default function AssignmentExampleCard({ category, accent = 'purple', title, start, due, duration, fee }) {
  ...
  return (
    <div className="bg-white rounded-xl p-6 border border-[rgba(96,96,163,0.2)] shadow-sm hover:-translate-y-1 hover:shadow-card-hover transition-all duration-short">
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2">
          <span className="w-2.5 h-2.5 rounded-full bg-brand-purple border border-text-primary shrink-0" />
          <div className="flex-1 relative h-px bg-[rgba(96,96,163,0.25)]">
