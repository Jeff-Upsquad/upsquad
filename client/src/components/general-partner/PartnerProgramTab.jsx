...
const partnerFocus = [
  {
    ...
    desc: "You're assigned one or more clients and work with them regularly — steady relationships, not one-off projects.",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Do your best work — that's it. A dedicated Squad Manager handles the clients.",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const planCards = [
  {
    ...
    deliverables: 'e.g. 2 tasks per day',
    payment: '5,000',
    highlighted: false,
  },
  {
    ...
    deliverables: 'e.g. 5 tasks per week',
    payment: '15,000',
    highlighted: false,
  },
  {
    ...
    deliverables: 'e.g. 20 tasks per month',
    payment: '20,000',
    highlighted: true,
    badge: 'POPULAR',
  },
  {
    ...
    deliverables: 'e.g. 30 tasks per month',
    payment: '30,000',
    highlighted: false,
  },
  {
          ...
          <div className="relative max-w-[1160px] mx-auto">
            ...
            <div className="mb-10 max-w-3xl">
              ...
              <h2 className="font-heading text-3xl sm:text-4xl font-extrabold text-text-primary leading-[1.1] tracking-tight">
                Stop hustling.{' '}
                <span className="italic font-medium text-text-muted">Start earning.</span>
              </h2>
              <p className="text-base text-text-secondary leading-relaxed mt-4">
                You&apos;re assigned one or more clients and work with them on a regular basis — on your own virtual office hours, with guaranteed monthly pay. We take care of everything else.
              </p>
            </div>
          ...
          <div className="max-w-[1160px] mx-auto">
            <div className="mb-10">
              ...
              <p className="text-base text-text-secondary mt-2 max-w-2xl">
                ...
                assigned clients — Assignments are for one-off tasks you pick up whenever it suits you.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="rounded-xl p-6 border border-[rgba(0,0,0,0.08)] bg-surface-secondary hover:-translate-y-0.5 transition-transform duration-200">
                ...
                <div className="flex items-center gap-2 text-xs text-text-muted">
                  ...
                  Ideal for starting your career
                </div>
              </div>
              ...
              <div className="rounded-xl p-6 border border-[rgba(0,0,0,0.08)] bg-surface-secondary hover:-translate-y-0.5 transition-transform duration-200">
                ...
                <p className="text-sm text-text-secondary leading-relaxed mb-4">
                  Top talents with 5+ years of experience. Best for high-stakes, complex, or premium work.
                </p>
                <div className="flex items-center gap-2 text-xs text-text-muted">
