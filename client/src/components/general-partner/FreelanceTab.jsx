...
const howItWorks = [
  {
    ...
    description: 'New assignments are posted regularly. Each one lists the scope, the fixed fee, and the deadline upfront.',
  },
  {
    number: '2',
...
const assignmentTypes = [
  ...
  { category: 'Video', accent: 'blue', title: 'Short-form reel edit', start: '23 Jun', due: '25 Jun', duration: '2 days', fee: '1,500' },
  { category: 'Sales', accent: 'purple', title: 'Lead-list build (200 contacts)', start: '22 Jun', due: '26 Jun', duration: '4 days', fee: '2,200' },
  { category: 'Sales', accent: 'blue', title: 'Outbound email campaign', start: '23 Jun', due: '27 Jun', duration: '4 days', fee: '2,500' },
  { category: 'Accounts', accent: 'purple', title: 'Monthly GST filing', start: '24 Jun', due: '27 Jun', duration: '3 days', fee: '2,000' },
  { category: 'Accounts', accent: 'blue', title: 'Bookkeeping catch-up', start: '24 Jun', due: '28 Jun', duration: '4 days', fee: '2,800' },
]
        ...
        <section className="py-16 lg:py-20 px-5 sm:px-8 bg-surface-secondary">
          <div className="max-w-[1160px] mx-auto">
            ...
            <p className="mt-4 text-base md:text-lg text-text-secondary leading-relaxed max-w-2xl">
              Not ready to commit to a regular client? Browse standalone
