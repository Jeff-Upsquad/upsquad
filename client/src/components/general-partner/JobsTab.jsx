...
const howItWorks = [
  {
    ...
    description: 'Tell us your role, skills, expected salary, and where you want to work.',
  },
  {
    number: '2',
    title: 'Browse matching openings',
    description: 'See full-time and part-time roles from companies and brands that hire through UpSquad.',
  },
  {
    number: '3',
  ...
  },
  {
    number: '4',
    title: 'Get hired',
    description: 'Accept the offer and start your new role with the brand — full-time or part-time.',
  },
]
        ...
        <section className="py-16 lg:py-20 px-5 sm:px-8 bg-white">
          <div className="max-w-[1160px] mx-auto">
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-extrabold text-text-primary tracking-[-0.025em] max-w-3xl">
              Land a full-time or part-time job with brands hiring through UpSquad.
            </h2>
            <p className="mt-4 text-base md:text-lg text-text-secondary leading-relaxed max-w-2xl">
              Companies and brands that work with UpSquad are hiring across every role — design, video,
              sales, and accounting — for full-time and part-time positions. Browse new openings, and when one matches what you&apos;re looking for,
              apply directly through us. We help you get noticed and guide you through the process.
            </p>
          ...
          <div className="max-w-[1160px] mx-auto">
            <div className="mb-10">
              ...
              <p className="text-base text-text-secondary mt-2 max-w-2xl">
                A sample of the kinds of roles brands post through UpSquad. Set your preferences to get matched to live openings.
              </p>
            </div>
            ...
            <div className="rounded-2xl border-[1.5px] border-black bg-brand-purple/15 shadow-brutal p-7 sm:p-9 flex flex-col sm:flex-row sm:items-center justify-between gap-5">
              <div>
                ...
                <p className="text-sm text-text-secondary mt-2 max-w-xl leading-relaxed">
                  ...
                  brands hiring through UpSquad — and you only pay once you&apos;re placed.
                </p>
              </div>
              <PartnerSignupLink
                href={signupUrl}
